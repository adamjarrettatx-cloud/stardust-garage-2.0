...
export const AUTH_THEMES = {
  dark: {
    ...
    violetBorder: 'rgba(168,85,247,0.3)',
  ...
  light: {
    ...
    violet: '#7e22ce',
    violetStrong: '#6b21a8',
    violetBg: 'rgba(147,51,234,0.12)',
    violetBorder: 'rgba(147,51,234,0.35)',
...
export function authThemeVars(themeName) {
  ...
  return {
    ...
    '--auth-panel-border': t.panelBorder,
    ...
    '--auth-info': t.info,
    '--auth-info-strong': t.infoStrong,
    '--auth-info-bg': t.infoBg,
    '--auth-info-border': t.infoBorder,
    '--auth-violet': t.violet,
    '--auth-violet-strong': t.violetStrong,
    '--auth-violet-bg': t.violetBg,
    '--auth-violet-border': t.violetBorder,
