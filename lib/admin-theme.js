...
// stay in visual lockstep. The Events Calendar convention is the source of truth
...
export const FINANCIAL_THEMES = {
  dark: {
    ...
    // SpotOn point-of-sale accent — a blue distinct from the green event-revenue
    // `rev` hue, so a day's POS-only money never reads as ambiguous with (or
    // gets lost next to) named-event income in the calendar/trends views.
    pos: '#60a5fa', posCardBg: '#0f1420', posCardBorder: 'rgba(96,165,250,0.25)',
    posChipBg: 'rgba(96,165,250,0.14)', posChipBorder: 'rgba(96,165,250,0.32)',
    posDetailBg: '#0f1420', posDetailBorder: 'rgba(96,165,250,0.25)',
  },
  light: {
    ...
    pos: '#1d4ed8', posCardBg: '#eef3ff', posCardBorder: 'rgba(29,78,216,0.28)',
    posChipBg: 'rgba(29,78,216,0.10)', posChipBorder: 'rgba(29,78,216,0.3)',
    posDetailBg: '#eef3ff', posDetailBorder: 'rgba(29,78,216,0.22)',
  },
};
