...
// ---------------------------------------------------------------------------
// ticket_v2 — alcohol references removed. 21+ venue policy is enforced at
// the door via ID check; the waiver itself is alcohol-neutral. Everything
// else in v1 (assumption of risk, express-negligence release, indemnity,
// photo/video release, no-refund, ejection, TX forum + jury waiver, $100
// cap, severability, e-signature) is preserved verbatim.
// ---------------------------------------------------------------------------

const TICKET_V2_LABEL =
  "I have read and agree to the Stardust Garage Assumption of Risk, Waiver, and Release of Liability, the Photo/Video Release, and the No-Refund Policy shown below. I am 18 or older.";

const TICKET_V2_BODY = `### ASSUMPTION OF RISK, WAIVER, AND RELEASE OF LIABILITY

**PLEASE READ CAREFULLY. THIS IS A LEGAL DOCUMENT THAT AFFECTS YOUR LEGAL RIGHTS. BY CHECKING THE BOX BELOW AND COMPLETING THIS TRANSACTION (WHETHER PAID, FREE, RSVP, MEMBER-CLAIMED, COMPLIMENTARY, OR OTHERWISE), YOU ARE ENTERING INTO A BINDING AGREEMENT WITH STARDUST GARAGE.**

For good and valuable consideration, including the issuance of a ticket, admission, RSVP confirmation, or entry credential (whether paid or free), the sufficiency of which is expressly acknowledged, I, the undersigned ticket holder, attendee, guest, member, or invitee ("**Attendee**," "**I**," or "**me**"), on behalf of myself, my heirs, spouse, children, personal representatives, executors, administrators, assigns, and next of kin, hereby agree as follows with **Simple Boring Office LLC**, a Texas limited liability company doing business as **Stardust Garage**, together with its owners, officers, members, managers, directors, employees, agents, independent contractors, security personnel, volunteers, promoters, event producers, performers, sponsors, insurers, landlords, and affiliated entities (collectively, "**Stardust Garage**"):

**1. Acknowledgment and Assumption of Inherent Risks.**
I acknowledge that attending events, entering the premises, and participating in any activity at or associated with Stardust Garage — including but not limited to warehouse events, nightlife events, day parties, DJ and live music performances, membership events, private events, and any other programming — involves **inherent and unavoidable risks of personal injury, illness, disability, permanent disability, death, property damage, emotional distress, and financial loss**. These risks include, without limitation:

(a) crowded and densely occupied spaces, crowd surges, pushing, shoving, moshing, dancing, and physical contact with other attendees;
(b) loud amplified music, sub-bass frequencies, strobe lights, lasers, fog, haze, pyrotechnics, and other production elements that may cause hearing loss, seizures, disorientation, or injury;
(c) slip, trip, and fall hazards, including wet floors, spilled liquids, uneven surfaces, cords, stairs, ramps, and dark or low-light conditions;
(d) exposure to communicable diseases, viruses, and illnesses transmitted person-to-person;
(e) criminal acts, intentional torts, harassment, assault, battery, theft, or negligent acts of other attendees, guests, third parties, performers, vendors, or trespassers;
(f) equipment failure, structural conditions of a warehouse venue, temperature extremes, and lack of climate control;
(g) travel to and from the venue, including parking areas, sidewalks, and surrounding streets; and
(h) any other risk, whether foreseeable or unforeseeable, ordinary or extraordinary, inherent in attending a nightlife, warehouse, or event venue.
...
**5. Conduct, Compliance, and Ejection.**
I represent and warrant that: (a) I will comply with all rules of the venue, the directions of Stardust Garage staff and security, and all applicable federal, state, and local laws; (b) I will not enter or remain on the premises if I am a danger to myself or others; and (c) I understand that Stardust Garage may refuse entry, refuse service, or eject me at its sole discretion, without refund.
...
**Contracting Entity:** Simple Boring Office LLC d/b/a Stardust Garage, Travis County, Texas`;
...
export const WAIVER_VERSIONS = [
  ...
  },
  {
    ...
    checkboxLabel: TICKET_V2_LABEL,
    bodyMarkdown: TICKET_V2_BODY,
    active: true,
  },
];
