...
export const PLAN_DISPLAY = {
  // Internal key stays 'cowork' (matches Stripe + DB), display label is now "The Builder".
  cowork: 'The Builder',
  // Internal key stays 'iykyk' (matches Stripe + DB), display label is now "The Insider".
  iykyk: 'The Insider',
};
