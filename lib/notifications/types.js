...
export const NOTIFICATION_TYPES = {
  w9_review_requested: {
    id: 'w9_review_requested', category: CATEGORIES.ADMIN,
    label: 'Artist W-9 review', description: 'A signed W-9 is ready for an authorized reviewer.',
    defaultChannels: { in_app: true, push: false, email: false },
    requiresEmail: false, userConfigurable: false,
  },
  w9_reviewed: {
    id: 'w9_reviewed', category: CATEGORIES.STAFF,
    label: 'W-9 review result', description: 'Your W-9 was approved or needs a new submission.',
    defaultChannels: { in_app: true, push: false, email: false },
    requiresEmail: false, userConfigurable: false,
  },
  // ===================== TICKETS =====================
  ...
  door_checkin: {
    ...
    description: 'Confirmation after door staff scans you in.',
    defaultChannels: { in_app: true, push: true, email: false },
    requiresEmail: false,
    userConfigurable: true,
  },
