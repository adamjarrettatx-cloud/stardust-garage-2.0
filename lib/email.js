    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:${BRAND.bgFallback};">
      <tr><td align="center" style="padding:0;">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background:${BRAND.cardBg};max-width:600px;border:1px solid ${BRAND.cardBorder};">
          ${heroHtml}
          <tr><td style="padding:8px 24px 28px 24px;text-align:center;background:${BRAND.cardBg};border-top:1px solid ${BRAND.cardBorder};">
            <div style="font-size:11px;color:${BRAND.textMuted};text-transform:uppercase;letter-spacing:0.24em;font-family:${BRAND.fontBody};margin-top:12px;">You're in</div>
          ...
          ${eventFlyerUrl ? `<tr><td style="padding:20px 24px 0 24px;background:${BRAND.cardBg};"><img src="${eventFlyerUrl}" alt="" style="display:block;width:100%;max-height:280px;object-fit:cover;border:1px solid ${BRAND.cardBorder};" /></td></tr>` : ''}
