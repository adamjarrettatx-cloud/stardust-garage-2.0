...
function renderTicketRow({ ticketCode, productName, tierName, qrSvg, viewUrl }) {
        ...
        <table style="width:100%;border-collapse:collapse;">
          <tr>
            <td style="vertical-align:top;width:140px;padding-right:16px;">
              <div style="width:140px;height:140px;">${qrSvg}</div>
            </td>
...
export async function sendTicketConfirmation({
  ...
  if (!to) return null;
  const rowsHtml = ticketRows.map(renderTicketRow).join('');
