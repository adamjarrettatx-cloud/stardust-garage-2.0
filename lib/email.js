...
function renderTrialPassHtml({ fullName, passUrl, expiresLabel }) {
  const safeName = escapeHtml((fullName || '').split(' ')[0] || 'there');
  return `<!DOCTYPE html><html><body style="margin:0;padding:24px;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#f5f5f5;"><div style="max-width:560px;margin:0 auto;background:#141414;border-radius:14px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);"><div style="padding:40px 32px 32px 32px;text-align:center;"><div style="font-size:11px;letter-spacing:0.32em;font-weight:600;color:rgba(255,255,255,0.4);margin-bottom:8px;">STARDUST</div><div style="font-size:12px;letter-spacing:0.32em;font-weight:400;color:rgba(255,255,255,0.4);margin-bottom:36px;">GARAGE</div><h1 style="font-size:28px;font-weight:800;margin:0 0 16px 0;letter-spacing:-0.02em;line-height:1.2;color:#ffffff;">Your Trial SDG Pass is ready.</h1><p style="font-size:15px;line-height:1.65;color:rgba(255,255,255,0.75);margin:0 0 24px 0;text-align:left;">${safeName}, thanks for signing up. Your 30-day trial starts the first night you come out — show the code below at the door to activate it. Open your pass and save it to your phone so you have it on hand.</p><a href="${passUrl}" style="display:inline-block;background:#ffffff;color:#0a0a0a;padding:14px 28px;border-radius:999px;font-size:11px;font-weight:600;letter-spacing:0.18em;text-decoration:none;margin-bottom:24px;">OPEN MY PASS</a><div style="background:#0a0a0a;border:1px solid rgba(255,255,255,0.1);border-radius:10px;padding:18px 20px;margin:0 0 8px 0;text-align:left;"><div style="font-size:11px;letter-spacing:0.14em;font-weight:600;color:#888;margin-bottom:8px;">ACTIVATE BY</div><div style="font-size:15px;color:#ffffff;font-weight:600;">${escapeHtml(expiresLabel)}</div><div style="font-size:12px;color:rgba(255,255,255,0.5);margin-top:6px;">Your 30 days start on your first visit.</div></div><p style="font-size:13px;line-height:1.6;color:rgba(255,255,255,0.5);margin:16px 0 0 0;text-align:left;">Your pass covers Friday through Sunday music events. Come use it, then apply for membership before your 30 days run out to keep your access — we'll remind you along the way.</p></div><div style="padding:18px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.05);font-size:11px;color:rgba(255,255,255,0.35);">4319 Terry-O Ln · Austin, TX 78745 · hello@sdgatx.com</div></div></body></html>`;
}
...
function renderTrialReminderHtml({ fullName, passUrl, applyUrl, daysLeft, expiresLabel, kind }) {
  ...
  if (kind === 'activation_nudge') {
    ...
    const body = `You picked up a Trial SDG Pass but haven't come out yet — your 30-day trial doesn't start until your first visit. We do Friday through Sunday music events. Come by, show the code at the door, and the clock starts then.`;
    return `<!DOCTYPE html><html><body style="margin:0;padding:24px;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#f5f5f5;"><div style="max-width:560px;margin:0 auto;background:#141414;border-radius:14px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);"><div style="padding:40px 32px 32px 32px;text-align:center;"><div style="font-size:11px;letter-spacing:0.32em;font-weight:600;color:rgba(255,255,255,0.4);margin-bottom:8px;">STARDUST</div><div style="font-size:12px;letter-spacing:0.32em;font-weight:400;color:rgba(255,255,255,0.4);margin-bottom:36px;">GARAGE</div><h1 style="font-size:28px;font-weight:800;margin:0 0 16px 0;letter-spacing:-0.02em;line-height:1.2;color:#ffffff;">${heading}</h1><p style="font-size:15px;line-height:1.65;color:rgba(255,255,255,0.75);margin:0 0 32px 0;text-align:left;">${body}</p><a href="${passUrl}" style="display:inline-block;background:#ffffff;color:#0a0a0a;padding:14px 28px;border-radius:999px;font-size:11px;font-weight:600;letter-spacing:0.18em;text-decoration:none;margin-bottom:16px;">OPEN MY PASS</a><p style="font-size:13px;line-height:1.6;color:rgba(255,255,255,0.5);margin:8px 0 0 0;">Activate by ${escapeHtml(expiresLabel)}.</p></div><div style="padding:18px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.05);font-size:11px;color:rgba(255,255,255,0.35);">4319 Terry-O Ln · Austin, TX 78745 · hello@sdgatx.com</div></div></body></html>`;
  }
...
function renderContractCompletedHtml({ fullName, documentTitle, portalUrl }) {
  const safeName = escapeHtml((fullName || '').split(' ')[0] || 'there');
  const safeTitle = escapeHtml(documentTitle || 'Contract');
  return `<!DOCTYPE html><html><body style="margin:0;padding:24px;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#f5f5f5;"><div style="max-width:560px;margin:0 auto;background:#141414;border-radius:14px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);"><div style="padding:40px 32px 32px 32px;text-align:center;"><div style="font-size:11px;letter-spacing:0.32em;font-weight:600;color:rgba(255,255,255,0.4);margin-bottom:8px;">STARDUST</div><div style="font-size:12px;letter-spacing:0.32em;font-weight:400;color:rgba(255,255,255,0.4);margin-bottom:36px;">GARAGE</div><h1 style="font-size:28px;font-weight:800;margin:0 0 16px 0;letter-spacing:-0.02em;line-height:1.2;color:#ffffff;">${safeName}, we're all signed.</h1><p style="font-size:15px;line-height:1.65;color:rgba(255,255,255,0.75);margin:0 0 32px 0;text-align:left;"><strong style="color:#fff;">${safeTitle}</strong> is fully executed. Our e-signature provider has emailed you the completed copy for your records, and we've filed ours.</p><a href="${portalUrl}" style="display:inline-block;background:#ffffff;color:#0a0a0a;padding:14px 28px;border-radius:999px;font-size:11px;font-weight:600;letter-spacing:0.18em;text-decoration:none;">VIEW IN MY PORTAL</a></div><div style="padding:18px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.05);font-size:11px;color:rgba(255,255,255,0.35);">4319 Terry-O Ln · Austin, TX 78745 · hello@sdgatx.com</div></div></body></html>`;
}
...
function renderTicketRow({ ticketCode, qrCid, viewUrl }) {
  const qrHtml = qrCid
    ? `<img src="cid:${qrCid}" alt="Ticket QR" width="140" height="140" style="display:block;width:140px;height:140px;border:0;" />`
    : '';
  return `
    <tr>
        ...
        <table style="width:100%;border-collapse:collapse;">
          <tr>
            ...
            <td style="vertical-align:top;">
              <div style="font-size:11px;color:#888;letter-spacing:0.06em;text-transform:uppercase;">Ticket code</div>
              <div style="font-size:12px;color:#333;margin-top:2px;font-family:'SF Mono',Menlo,Monaco,Consolas,monospace;word-break:break-all;">${ticketCode}</div>
              ${viewUrl ? `<div style="margin-top:10px;"><a href="${viewUrl}" style="color:#111;text-decoration:underline;font-size:13px;">Open ticket</a></div>` : ''}
            </td>
          </tr>
        </table>
      </td>
...
function renderTicketGroupHeader({ productName, tierName, quantity, unitPriceCents, subtotalCents, currency }) {
  ...
  const qtyPriceLine = qtyPriceParts.length
    ? `<div style="font-size:13px;color:#555;margin-top:4px;">${qtyPriceParts.join(' · ')}</div>`
    : '';
  ...
  const subtotalHtml = showSubtotal
    ? `<td style="vertical-align:top;text-align:right;font-size:15px;color:#111;font-weight:700;white-space:nowrap;padding-left:12px;">${formatMoneyCents(subtotalCents, currency)}</td>`
    : '';
  return `
    <tr>
      <td style="padding:20px 24px 8px 24px;border-top:1px solid #eee;">
        <table style="width:100%;border-collapse:collapse;">
          <tr>
            <td style="vertical-align:top;">
              <div style="font-size:16px;color:#111;font-weight:800;line-height:1.3;">${label}</div>
              ${qtyPriceLine}
            </td>
            ${subtotalHtml}
          </tr>
...
function renderOrderTotals(totals, currency) {
  ...
  const push = (label, cents, opts = {}) => {
    ...
    rows.push(`
      <tr>
        <td style="padding:4px 0;font-size:13px;color:#555;">${label}</td>
        <td style="padding:4px 0;font-size:13px;color:#555;text-align:right;">${amount}</td>
      </tr>`);
  };
  push('Subtotal', totals.subtotalCents);
  push('Discount', totals.discountCents, { negate: true });
  push('Fees', totals.feesCents);
  push('Tax', totals.taxCents);
  ...
  return `
    <tr><td style="padding:16px 24px 20px 24px;border-top:1px solid #eee;">
      <table role="presentation" style="width:100%;max-width:280px;margin-left:auto;border-collapse:collapse;">
        ${rows.join('')}
        <tr>
          <td style="padding:10px 0 0 0;font-size:15px;color:#111;font-weight:700;border-top:1px solid #eee;">${totalLabel}</td>
          <td style="padding:10px 0 0 0;font-size:15px;color:#111;font-weight:700;text-align:right;border-top:1px solid #eee;">${totalAmount}</td>
        </tr>
      </table>
    </td></tr>`;
}
...
export async function sendTicketConfirmation({
  ...
  if (orderDate) {
    ...
    orderDateHtml = `<div style="font-size:12px;color:#666;margin-top:2px;">Ordered ${formatted}</div>`;
  }

  const flyerHtml = eventFlyerUrl
    ? `<tr><td style="padding:0;"><img src="${eventFlyerUrl}" alt="" style="display:block;width:100%;max-height:280px;object-fit:cover;" /></td></tr>`
    : '';

  const addressHtml = venueAddress
    ? `<div style="font-size:13px;color:#444;margin-top:4px;">${venueAddress}</div>`
    : '';

  const ctaHtml = orderUrl
    ? `<div style="margin-top:16px;">
         <a href="${orderUrl}" style="display:inline-block;padding:12px 22px;background:#ffffff;color:#0a0a0a;border:1px solid #0a0a0a;border-radius:999px;font-size:12px;font-weight:700;letter-spacing:0.14em;text-decoration:none;">VIEW IN YOUR ACCOUNT</a>
       </div>`
    : '';

  const html = `<!DOCTYPE html><html><body style="margin:0;background:#f6f6f6;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;color:#111;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr><td align="center" style="padding:24px 12px;">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background:#fff;border:1px solid #eee;">
        ${flyerHtml}
        <tr><td style="padding:24px;">
          <div style="font-size:12px;color:#666;text-transform:uppercase;letter-spacing:0.08em;">Stardust Garage</div>
          <h1 style="font-size:22px;margin:8px 0 4px;">You're in.</h1>
          <div style="font-size:20px;color:#111;font-weight:800;margin-top:8px;line-height:1.25;">${eventTitle || ''}</div>
          ${eventWhen ? `<div style="font-size:14px;color:#444;margin-top:4px;">${eventWhen}</div>` : ''}
          ${addressHtml}
          <div style="font-size:12px;color:#666;margin-top:8px;">Order ${orderId}</div>
          ${orderDateHtml}
          ${ctaHtml}
        </td></tr>
        <tr><td>
        ...
        ${totalsHtml}
        <tr><td style="padding:20px 24px;border-top:1px solid #eee;font-size:13px;color:#666;line-height:1.5;">
          Show the QR at the door. Each code is single-use. If your plans change, reach us at hello@sdgatx.com.
          ${orderUrl ? `<div style="margin-top:12px;"><a href="${orderUrl}" style="color:#111;">View this order online</a></div>` : ''}
        </td></tr>
      </table>
    </td></tr></table>
  </body></html>`;
