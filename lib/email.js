...
function renderPartnerInviteHtml({ fullName, contactType, activationUrl }) {
...
export async function sendPartnerInvite({ email, fullName, contactType, activationUrl }) {
  ...
  return sendEmail({
    ...
    html: renderPartnerInviteHtml({ fullName, contactType, activationUrl }),
  });
}
