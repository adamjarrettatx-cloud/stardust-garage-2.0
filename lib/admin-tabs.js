...
export const ADMIN_TABS = [
  ...
  // list. `rendersOwnContent` tells the tile-grid contract (and its test) that
  // an empty tile set is deliberate here — app/bananas/page.js renders the
  // EVENTS list into this section instead.
  //
  ...
  // the pending-pay-request badge belongs beside Events instead.
  {
    ...
    description: 'Every event on the calendar, upcoming and past.',
  },
...
export const ADMIN_TILES = {
  ...
  team: [
    ...
    // Team Chat used to be a third tile here. It is now its own OPERATIONS
    // section directly below Events, so /team/chat is reached from the sidebar.
  ],
  memberships: [
