...
// public page 404s events that are internal or still drafts. Unlisted events
// DO resolve at /events/[slug] for anyone with the URL, so a link to one is
// still useful — team members with the link can open it just like any invited
// guest. Returns null when there is no page the viewer can actually open, so
// callers render plain text instead of a dead link.
