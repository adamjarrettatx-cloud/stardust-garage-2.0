...
export const VIEW_PERSONAS = Object.freeze([
  ...
  { id: 'promoter', label: 'Promoter', group: 'Persons', path: '/portal/profile', partner: ['promoter'], description: 'Own profile and guest lists. No bookings, pay or contracts.' },
  { id: 'collective', label: 'Organization · Collective', group: 'Organizations', viewType: 'organization', scenario: 'Collective', path: '/portal/profile', partner: ['collective'], description: 'Assigned events and ticket sales, guest lists and agreements. No bookings or pay.' },
  ...
  { id: 'organizer', label: 'Organization · Event Organizer', group: 'Organizations', viewType: 'organization', scenario: 'Event Organizer', path: '/portal/profile', partner: ['event_organizer'], description: 'Assigned events and ticket sales, guest lists and agreements. No bookings or pay.' },
