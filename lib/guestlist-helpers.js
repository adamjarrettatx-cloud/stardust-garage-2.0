...
// The allocation panel sits below a long event form, so anything linking to it
// has to name it rather than dropping the admin at the top of the page. Lives
// here, not in the panel, so a server component can build the href without
// importing across the client boundary.
export const GUEST_LIST_ANCHOR = 'guest-list-allocation';
