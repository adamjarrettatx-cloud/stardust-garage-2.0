...
// Contact types that can be booked and paid as a Phase-2 artist/DJ event
// booking (see lib/booking-helpers.js). Shared here rather than in
// booking-helpers.js since it's a fact about contacts, not about bookings —
// other future features (e.g. a "pending 1099s" contact filter) can reuse it
// too without importing the booking module.
