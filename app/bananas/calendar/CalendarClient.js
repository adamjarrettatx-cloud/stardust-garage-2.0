                    ...
                    {team.slice(0, 3 - Math.min(pub.length, 2)).map(evt => {
                      ...
                      return (
                        <div
                          ...
                          className="text-[11px] font-semibold px-1.5 py-1 rounded cursor-pointer hover:opacity-80 transition-opacity"
                          style={{ background: cat.color + t.chipTintAlpha, color: chipColor, border: `1px solid ${cat.color}${t.chipBorderAlpha}` }}
                          title={evt.title}
                        >
                  ...
                  {selectedEvents.team.map(evt => {
                    ...
                    return (
                      <div
                        ...
                        style={{ background: cat.color + (theme === 'light' ? '14' : '22'), border: `1px solid ${cat.color}${t.chipBorderAlpha}` }}
