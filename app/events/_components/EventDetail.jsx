...
// (app/events/[slug]/preview/page.js) so a draft renders pixel-identically to
// how it will look after GO LIVE. Keep this purely presentational — the
// caller is responsible for fetching the row and enforcing visibility rules.
    ...
    <main className="max-w-[1100px] mx-auto px-4 md:px-6 py-8 md:py-10">
      ...
      <div className="grid gap-6 md:gap-12 md:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] md:items-start">
        ...
        <section className="flex flex-col md:block">
          <h1
            className="order-3 text-[28px] md:text-[32px] font-extrabold -tracking-[0.02em] mb-1.5 leading-[1.1]"
            style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
          >
            {event.title}
          </h1>
          <div
            className="order-4 text-[20px] md:text-[22px] font-bold -tracking-[0.01em] mb-5"
            style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
          >
