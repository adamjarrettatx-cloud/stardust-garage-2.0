...
const ERRORS = {
  no_invite:
    "That Google account isn't linked to a Stardust Garage invite. If you work with us, " +
    'check that you picked the same address we invited — or contact SDG and we\'ll send a new invite.',
  link_conflict:
    'That Google account is already the login for a different Stardust Garage collaborator. Contact SDG so we can sort it out.',
