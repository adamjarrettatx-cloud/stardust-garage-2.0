...
const features = [
  { icon: 'wifi', title: 'Gigabit Fiber Internet', desc: 'Built for big uploads, video calls, and large files.' },
  { icon: 'bottle', title: 'Refreshments On Hand', desc: 'A stocked selection of healthy drinks and snacks, restocked regularly.' },
...
function FeatureIcon({ name }) {
  const props = { width: 26, height: 26, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round' };
  if (name === 'wifi') return (<svg {...props}><path d="M5 12.55a11 11 0 0 1 14.08 0" /><path d="M1.42 9a16 16 0 0 1 21.16 0" /><path d="M8.53 16.11a6 6 0 0 1 6.95 0" /><line x1="12" y1="20" x2="12.01" y2="20" /></svg>);
  if (name === 'coffee') return (<svg {...props}><path d="M18 8h1a4 4 0 0 1 0 8h-1" /><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" /><line x1="6" y1="1" x2="6" y2="4" /><line x1="10" y1="1" x2="10" y2="4" /><line x1="14" y1="1" x2="14" y2="4" /></svg>);
  if (name === 'bottle') return (<svg {...props}><path d="M10 2h4" /><path d="M10 2v3.2a3 3 0 0 1-.6 1.8L8.2 8.6A4 4 0 0 0 7.4 11v8a3 3 0 0 0 3 3h3.2a3 3 0 0 0 3-3v-8a4 4 0 0 0-.8-2.4L14.6 7A3 3 0 0 1 14 5.2V2" /><line x1="7.4" y1="13" x2="16.6" y2="13" /></svg>);
  ...
  if (name === 'lock') return (<svg {...props}><rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>);
