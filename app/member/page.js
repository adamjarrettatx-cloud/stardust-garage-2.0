  ...
  return (
    <main className="max-w-[900px] mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/member/studio" className="relative rounded-[14px] p-7 border transition-all hover:-translate-y-0.5 hover:border-white/15" style={{ background: '#141414', borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <p className="text-[13px]" style={{ color: '#8a8a8a' }}>Reserve studio hours.</p>
        </Link>

        <Link href="/member/bookings" className="relative rounded-[14px] p-7 border transition-all hover:-translate-y-0.5 hover:border-white/15" style={{ background: '#141414', borderColor: 'rgba(255,255,255,0.06)' }}>
          ...
          <p className="text-[13px]" style={{ color: '#8a8a8a' }}>Your upcoming studio sessions.</p>
          {upcomingCount > 0 && (
