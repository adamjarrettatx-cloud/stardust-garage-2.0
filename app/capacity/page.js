  ...
  return (
    <main className="max-w-[760px] mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Tile href="/capacity/front-desk" eyebrow="LAPTOP · FRONT DESK" title="Front Desk" desc="Live capacity, guest list, unified QR scanner (member + trial pass), issue a trial pass" color="#c084fc" />
