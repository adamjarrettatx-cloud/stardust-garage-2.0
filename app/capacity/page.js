  ...
  return (
    <main className="max-w-[760px] mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Tile href="/capacity/front-desk" eyebrow="LAPTOP · FRONT DESK" title="Front Desk" desc="Live capacity, guest list, unified QR scanner (member + trial pass), issue a trial pass" color="#8a5109" />
        ...
        <Tile href="/capacity/front-door" eyebrow="JELLY2 · FRONT" title="Front Door" desc="Big green check-in button" color="#d9c48c" />
        ...
        {isAdmin && (
          <Tile href="/capacity/admin" eyebrow="ADMIN" title="Setup & History" desc="Start/end session, set max, reset, audit log" color="#d9c48c" />
        )}
      </div>
    </main>
  );
