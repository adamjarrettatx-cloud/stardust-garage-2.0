...
// GET /partner/auth/callback?code=...
//
...
// URL fragment, which the browser client picks up on /partner/activate without
...
export async function GET(request) {
  ...
  const destination = profile.is_active ? '/partner/profile' : '/partner/activate';
